...
//escala ascendente
  appConfig.SCALE_NOTES_ASC[0].PR2 = 237;//DO
  appConfig.SCALE_NOTES_ASC[1].PR2 = 211;//RE
  appConfig.SCALE_NOTES_ASC[2].PR2 = 188;//MI
  appConfig.SCALE_NOTES_ASC[3].PR2 = 177;//FA
  appConfig.SCALE_NOTES_ASC[4].PR2 = 158;//SOL
  appConfig.SCALE_NOTES_ASC[5].PR2 = 141;//LA
  appConfig.SCALE_NOTES_ASC[6].PR2 = 125;//SI
  appConfig.SCALE_NOTES_ASC[0].CCPRL = 118;//DO
  appConfig.SCALE_NOTES_ASC[1].CCPRL = 105;//RE
  appConfig.SCALE_NOTES_ASC[2].CCPRL = 94;//MI
  appConfig.SCALE_NOTES_ASC[3].CCPRL = 88;//FA
  appConfig.SCALE_NOTES_ASC[4].CCPRL = 79;//SOL
  appConfig.SCALE_NOTES_ASC[5].CCPRL = 70;//LA
  appConfig.SCALE_NOTES_ASC[6].CCPRL = 62;//SI
  //escala descendente
  appConfig.SCALE_NOTES_DESC[6].PR2 = 237;//DO
  appConfig.SCALE_NOTES_DESC[5].PR2 = 211;//RE
  appConfig.SCALE_NOTES_DESC[4].PR2 = 188;//MI
  appConfig.SCALE_NOTES_DESC[3].PR2 = 177;//FA
  appConfig.SCALE_NOTES_DESC[2].PR2 = 158;//SOL
  appConfig.SCALE_NOTES_DESC[1].PR2 = 141;//LA
  appConfig.SCALE_NOTES_DESC[0].PR2 = 125;//SI
  appConfig.SCALE_NOTES_DESC[6].CCPRL = 118;
  appConfig.SCALE_NOTES_DESC[5].CCPRL = 105;
  appConfig.SCALE_NOTES_DESC[4].CCPRL = 94;
  appConfig.SCALE_NOTES_DESC[3].CCPRL = 88;
  appConfig.SCALE_NOTES_DESC[2].CCPRL = 79;
  appConfig.SCALE_NOTES_DESC[1].CCPRL = 70;
  appConfig.SCALE_NOTES_DESC[0].CCPRL = 62;
  //pista
